...
jQuery.fn = jQuery.prototype = {
  ...
  map : function(callback) {
    return this.pushStack(jQuery.map(
        this, function(elem, i) { return callback.call(elem, i, elem); }));
  },
...
jQuery.extend({
  ...
  isNumeric : function(obj) {
    ...
    // ("0x...") subtraction forces infinities to NaN adding 1 corrects loss of
    // precision from parseFloat (#15100)
  ...
  // Support: Android<4.1
  trim : function(
      text) { return text == null ? "" : (text + "").replace(rtrim, ""); },
  ...
  inArray : function(
      elem, arr, i) { return arr == null ? -1 : indexOf.call(arr, elem, i); },
  ...
  grep : function(elems, callback, invert) {
    var callbackInverse, matches = [], i = 0, length = elems.length,
  ...
  proxy : function(fn, context) {
    ...
    // Set the guid of unique handler to the same of original handler, so it can
    // be removed
...
jQuery.each(
    "Boolean Number String Function Array Date RegExp Object Error Symbol"
        .split(" "),
    function(
        i, name) { class2type["[object " + name + "]"] = name.toLowerCase(); });
...
var Sizzle =
     ...
     */
    (function(window) {
      var i, support, Expr, getText, isXML, tokenize, compile, select,
          outermostContext, sortInput, hasDuplicate,

          // Local document vars
          setDocument, document, docElem, documentIsHTML, rbuggyQSA,
          rbuggyMatches, matches, contains,

          // Instance-specific data
          expando = "sizzle" + 1 * new Date(), preferredDoc = window.document,
          dirruns = 0, done = 0, classCache = createCache(),
          tokenCache = createCache(), compilerCache = createCache(),
          sortOrder =
              function(a, b) {
            if (a === b) {
              hasDuplicate = true;
          ...
          // Instance methods
          hasOwn = ({}).hasOwnProperty, arr = [], pop = arr.pop,
          push_native = arr.push, push = arr.push, slice = arr.slice,
        ...
        push = {
          apply :
              arr.length ?
                  ...
                  function(target,
                           els) { push_native.apply(target, slice.call(els)); }
                         :
      ...
      function Sizzle(selector, context, results, seed) {
        ...
        if (!seed) {
          ...
          if (documentIsHTML) {
            ...
            // method (excepting DocumentFragment context, where the methods
            // don't exist)
            ...
            if (support.qsa && !compilerCache[selector + " "] &&
              ...
              if (nodeType !== 1) {
                ...
                i = groups.length;
                nidselect =
                    ridentifier.test(nid) ? "#" + nid : "[id='" + nid + "']";
                while (i--) {
       ...
       *storing it on itself with property name the (space-suffixed) string and
       *(if the cache is larger than Expr.cacheLength) deleting the oldest entry
       */
      ...
      */
        ...
        // names, so use a roundabout getElementsByName test
        ...
        if (support.getById) {
          ...
          Expr.filter["ID"] = function(id) {
            ...
            return function(
                elem) { return elem.getAttribute("id") === attrId; };
          };
        } else {
          // Support: IE6/7
      ...
      */
        ...
        // error See http://bugs.jquery.com/ticket/13378
        rbuggyQSA = [];
        ...
        if ((support.qsa = rnative.test(document.querySelectorAll))) {
          ...
          assert(function(div) {
            ...
            // are still enabled) IE8 throws error here and will not see later
            // tests
      ...
      */
        ...
        contains =
            hasCompare || rnative.test(docElem.contains) ? function(a, b) {
      ...
      */
        ...
        sortOrder = hasCompare ? function(a, b) {
          ...
          var cur, i = 0, aup = a.parentNode, bup = b.parentNode, ap = [ a ],
                   bp = [ b ];
      ...
      Sizzle.matches = function(
          expr, elements) { return Sizzle(expr, null, null, elements); };
      ...
      Expr = Sizzle.selectors = {
        ...
        filter : {
          ...
          "PSEUDO" : function(pseudo, argument) {
            ...
            // with uppercase letters Remember that setFilters inherits from
            // pseudos
        ...
        pseudos : {
          ...
          "last" : createPositionalPseudo(function(
              matchIndexes, length) { return [ length - 1 ]; }),
                       ...
                       while ((elem = elem[dir])) {
                         if (elem.nodeType === 1 || checkNonElements) {
                           ...
                           if ((oldCache = uniqueCache[dir]) &&
                             ...
                             // A match means we're done; a fail means we have
                             // to keep checking
      ...
      function setMatcher(preFilter, selector, matcher, postFilter, postFinder,
        ...
        return markFunction(function(seed, results, context, xml) {
          var temp, i, elem,
              preMap = [], postMap = [], preexisting = results.length,
      ...
      function matcherFromTokens(tokens) {
        var checkContext, matcher, j,
            ...
            // top-level context(s)
            matchContext =
                addCombinator(function(elem) { return elem === checkContext; },
                              implicitRelative, true),
            matchAnyContext = addCombinator(
                function(elem) { return indexOf(checkContext, elem) > -1; },
                implicitRelative, true),
              ...
              return setMatcher(
                  ...
                  i > 1 &&
                      toSelector(
                          ...
                          .replace(rtrim, "$1"),
                  matcher, i < j && matcherFromTokens(tokens.slice(i, j)),
      ...
      function matcherFromGroupMatchers(elementMatchers, setMatchers) {
        var bySet = setMatchers.length > 0,
            ...
            superMatcher = function(seed, context, xml, results, outermost) {
              var elem, j, matcher,
                  matchedCount = 0, i = "0", unmatched = seed && [],
              ...
              // to `matchedCount` makes the latter nonnegative.
              matchedCount += i;

              // Apply set filters to unmatched elements
              // NOTE: This can be skipped if there are no unmatched elements
              // (i.e., `matchedCount` equals `i`), unless we didn't visit _any_
              // elements in the above loop because we have no element matchers
              // and no seed. Incrementing an initially-string "0" `i` allows
              // `i` to remain a string only in that case, which will result in
              // a "00" `matchedCount` that differs from `i` but is also
              // numerically zero.
      ...
      compile = Sizzle.compile = function(selector,
        ...
        if (!cached) {
          ...
          cached = compilerCache(
              selector, matcherFromGroupMatchers(elementMatchers, setMatchers));
      ...
      select = Sizzle.select = function(selector, context, results, seed) {
        ...
        // and no seed (the latter of which guarantees us context)
        if (match.length === 1) {
          ...
          if (tokens.length > 2 && (token = tokens[0]).type === "ID" &&
            ...
            context =
                (Expr.find["ID"](token.matches[0].replace(runescape, funescape),
                                 context) ||
                 [])[0];
            if (!context) {
              return results;
        ...
        (compiled || compile(selector, match))(
            seed, context, !documentIsHTML, results,
            !context ||
      ...
      if (!assert(function(
              div) { return div.getAttribute("disabled") == null; })) {
...
function winnow(elements, qualifier, not) {
  ...
  if (qualifier.nodeType) {
    return jQuery.grep(elements,
                       function(elem) { return (elem === qualifier) !== not; });
  }
  ...
  return jQuery.grep(
      elements,
      function(elem) { return (indexOf.call(qualifier, elem) > -1) !== not; });
}
...
jQuery.filter = function(expr, elems, not) {
  ...
  return elems.length === 1 && elem.nodeType === 1
             ...
             : jQuery.find.matches(
                   expr,
                   jQuery.grep(elems,
                               function(elem) { return elem.nodeType === 1; }));
};
...
jQuery.fn.extend({
  ...
  filter : function(
      selector) { return this.pushStack(winnow(this, selector || [], false)); },
  not : function(
      selector) { return this.pushStack(winnow(this, selector || [], true)); },
  is : function(selector) {
    return !!winnow(
                 this,

                 // If this is a positional/relative selector, check membership
                 // in the returned set so $("p:first").is("p:last") won't
...
jQuery.each({
  ...
  parentsUntil : function(elem, i,
                          until) { return dir(elem, "parentNode", until); },
  ...
  nextUntil : function(elem, i,
                       until) { return dir(elem, "nextSibling", until); },
  prevUntil : function(elem, i,
                       until) { return dir(elem, "previousSibling", until); },
  siblings : function(
      elem) { return siblings((elem.parentNode || {}).firstChild, elem); },
...
function createOptions(options) {
  ...
  jQuery.each(options.match(rnotwhite) || [],
              function(_, flag) { object[flag] = true; });
  return object;
}
 ...
 *how the callback list behaves or a more traditional option object
 *
 ...
 *any callback added after the list has been fired right away with the latest
...
jQuery.extend({
  ...
  when : function(subordinate /* , ..., subordinateN */) {
    var i = 0, resolveValues = slice.call(arguments),
  ...
  if (jQuery.type(key) === "object") {
    ...
    if (bulk) {
      ...
      if (raw) {
        ...
        bulk = fn;
        fn = function(elem, key,
                      value) { return bulk.call(jQuery(elem), value); };
      }
    }
...
jQuery.extend({
  hasData : function(
      elem) { return dataUser.hasData(elem) || dataPriv.hasData(elem); },

  data : function(elem, name,
                  data) { return dataUser.access(elem, name, data); },
  ...
  _data : function(elem, name,
                   data) { return dataPriv.access(elem, name, data); },
...
jQuery.fn.extend({
  ...
  removeData : function(
      key) { return this.each(function() { dataUser.remove(this, key); }); }
});
...
jQuery.extend({
  ...
  dequeue : function(elem, type) {
    ...
    var queue = jQuery.queue(elem, type), startLength = queue.length,
        fn = queue.shift(), hooks = jQuery._queueHooks(elem, type),
...
jQuery.fn.extend({
  ...
  dequeue : function(
      type) { return this.each(function() { jQuery.dequeue(this, type); }); },
  clearQueue : function(type) { return this.queue(type || "fx", []); },

  // Get a promise resolved when queues of a certain type
  // are emptied (fx is the type by default)
  promise : function(type, obj) {
    var tmp, count = 1, defer = jQuery.Deferred(), elements = this,
             i = this.length, resolve = function() {
               if (!(--count)) {
...
function adjustCSS(elem, prop, valueParts, tween) {
  var adjusted,
      ...
      currentValue = tween ? function() { return tween.cur(); }
  ...
  if (initialInUnit && initialInUnit[3] !== unit) {
    ...
    do {
      ...
      // enough.
    } while (scale !== (scale = currentValue() / initial) && scale !== 1 &&
             --maxIterations);
  }
...
function buildFragment(elems, context, scripts, selection, ignored) {
  var elem, tmp, tag, wrap, contains, j,
      fragment = context.createDocumentFragment(), nodes = [], i = 0,
      l = elems.length;
...
function on(elem, types, selector, data, fn, one) {
  ...
  return elem.each(
      function() { jQuery.event.add(this, types, fn, data, selector); });
}
...
jQuery.event = {
  ...
  add : function(elem, types, handler, data, selector) {
    var handleObjIn, eventHandle, tmp, events, t, handleObj, special, handlers,
        type, namespaces, origType, elemData = dataPriv.get(elem);
    ...
    if (!(eventHandle = elemData.handle)) {
      eventHandle = elemData.handle = function(e) {
        ...
        return typeof jQuery !== "undefined" && jQuery.event.triggered !== e.type ? jQuery
                                                                                        .event
                                                                                        .dispatch
                                                                                        .apply(
                                                                                            elem,
    ...
    while (t--) {
      ...
      // If selector defined, determine special event api type, otherwise given
      // type
  ...
  remove : function(elem, types, handler, selector, mappedTypes) {
    var j, origCount, tmp, events, t, handleObj, special, handlers, type,
        namespaces, origType,
    ...
    while (t--) {
      ...
      // handlers exist (avoids potential for endless recursion during removal
      // of special event handlers)
  ...
  dispatch : function(event) {
    ...
    var i, j, ret, matched, handleObj,
        handlerQueue = [], args = slice.call(arguments),
    ...
    while ((matched = handlerQueue[i++]) && !event.isPropagationStopped()) {
      ...
      while ((handleObj = matched.handlers[j++]) &&
        ...
        // namespace(s) a subset or equal to those in the bound event (both can
        // have no namespace).
  ...
  fix : function(event) {
    ...
    var i, prop, copy, type = event.type, originalEvent = event,
...
jQuery.Event = function(src, props) {
  ...
  if (src && src.type) {
    ...
    this.isDefaultPrevented =
        src.defaultPrevented || src.defaultPrevented === undefined &&
...
jQuery.fn.extend({
  on : function(types, selector, data,
                fn) { return on(this, types, selector, data, fn); },
  one : function(types, selector, data,
                 fn) { return on(this, types, selector, data, fn, 1); },
  off : function(types, selector, fn) {
    ...
    return this.each(
        function() { jQuery.event.remove(this, types, fn, selector); });
  }
});
...
function domManip(collection, args, callback, ignored) {
  ...
  var fragment, first, scripts, hasScripts, node, doc,
      i = 0, l = collection.length, iNoClone = l - 1, value = args[0],
  ...
  if (l) {
    ...
    // Require either new content or an interest in ignored elements to invoke
    // the callback
    if (first || ignored) {
...
jQuery.extend({
  htmlPrefilter : function(
      html) { return html.replace(rxhtmlTag, "<$1></$2>"); },
  ...
  replaceAll : "replaceWith"
            ...
            function(name, original) {
              jQuery.fn[name] = function(selector) {
                var elems, ret = [], insert = jQuery(selector),
                           last = insert.length - 1, i = 0;
...
function defaultDisplay(nodeName) {
  ...
  if (!display) {
    ...
    if (display === "none" || !display) {
      ...
      // Always write a new HTML skeleton so Webkit and Firefox don't choke on
      // reuse
...
jQuery.extend(support, {
  ...
  pixelMarginRight : function() {
    ...
    // We're checking for boxSizingReliableVal here instead of
    // pixelMarginRightVal since that compresses better and they're computed
    // together anyway.
    if (boxSizingReliableVal == null) {
      computeStyleTests();
    }
...
function getWidthOrHeight(elem, name, extra) {
  ...
  // null/undefined svg - https://bugzilla.mozilla.org/show_bug.cgi?id=649285
  ...
  for (; index < length; index++) {
    ...
    if (show) {
      ...
      if (elem.style.display === "" && isHidden(elem)) {
        values[index] =
            dataPriv.access(elem, "olddisplay", defaultDisplay(elem.nodeName));
      }
    } else {
  ...
  jQuery.cssHooks[name] = {
    ...
    set : function(elem, value, extra) {
      var matches,
          ...
          subtract =
              extra && augmentWidthOrHeight(elem, name, extra,
...
jQuery.cssHooks.marginLeft =
    addGetHookIf(support.reliableMarginLeft, function(elem, computed) {
      if (computed) {
...
jQuery.each(
    {margin : "", padding : "", border : "Width"}, function(prefix, suffix) {
...
Tween.prototype = {
  ...
  run : function(percent) {
    ...
    if (this.options.duration) {
      this.pos = eased =
          jQuery.easing[this.easing](percent, this.options.duration * percent,
...
function createTween(value, prop, animation) {
  var tween,
      collection =
          (Animation.tweeners[prop] || []).concat(Animation.tweeners["*"]),
...
function defaultPrefilter(elem, props, opts) {
  ...
  var prop, value, toggle, tween, hooks, oldfire, display, checkDisplay,
      anim = this, orig = {}, style = elem.style,
  ...
  if (elem.nodeType === 1 && ("height" in props || "width" in props)) {
    ...
    checkDisplay = display === "none" ? dataPriv.get(elem, "olddisplay") ||
...
function Animation(elem, properties, options) {
  var result, stopped,
      index = 0, length = Animation.prefilters.length,
      ...
      tick =
        ...
        var currentTime = fxNow || createFxNow(),
            ...
            // (#12497)
            temp = remaining / animation.duration || 0, percent = 1 - temp,
      ...
      animation = deferred.promise({
        ...
        opts : jQuery.extend(
            true, {specialEasing : {}, easing : jQuery.easing._default},
            options),
  ...
  jQuery.fx.timer(jQuery.extend(
      tick, {elem : elem, anim : animation, queue : animation.opts.queue}));
...
jQuery.fn.extend({
  ...
  stop : function(type, clearQueue, gotoEnd) {
    ...
    return this.each(function() {
      var dequeue = true, index = type != null && type + "queueHooks",
          timers = jQuery.timers, data = dataPriv.get(this);
...
jQuery.each(
    ...
    function(name, props) {
      jQuery.fn[name] = function(
          speed, easing,
          callback) { return this.animate(props, speed, easing, callback); };
    });
...
jQuery.fn.extend({
  addClass : function(value) {
    ...
    if (jQuery.isFunction(value)) {
      return this.each(function(
          j) { jQuery(this).addClass(value.call(this, j, getClass(this))); });
    }
  ...
  toggleClass : function(value, stateVal) {
    ...
    return this.each(function() {
      ...
      if (type === "string") {
        ...
        // it). Otherwise bring back whatever was previously saved (if
  ...
  val : function(value) {
    ...
    return this.each(function(i) {
      ...
      if (val == null) {
        ...
        val = jQuery.map(
            val, function(value) { return value == null ? "" : value + ""; });
      }
...
jQuery.extend(jQuery.event, {
  ...
  trigger : function(event, data, elem, onlyHandlers) {
    ...
    // Clone any incoming data and prepend the event, creating the handler arg
    // list
    ...
    if (!onlyHandlers && !special.noBubble && !jQuery.isWindow(elem)) {
      ...
      // Only add window if we got to document (e.g., not plain obj or detached
      // DOM)
    ...
    if (!onlyHandlers && !event.isDefaultPrevented()) {
      ...
      if ((!special._default ||
        ...
        // Call a native DOM method on the target with the same name name as the
        // event. Don't do default actions on window, that's where global
        // variables be (#6170)
  ...
  simulate : function(type, elem, event) {
    var e = jQuery.extend(new jQuery.Event(), event, {
      ...
      // for which stopPropagation() is noop, so there is no need for that
      // anymore.
      //
      // For the 1.x branch though, guard for "click" and "submit"
      // events is still used, but was moved to jQuery.event.stopPropagation
      // function because `originalEvent` should point to the original event for
      // the constancy with other events and for more focused logic
    });
...
jQuery.fn.extend({
  hover : function(
      fnOver,
      fnOut) { return this.mouseenter(fnOver).mouseleave(fnOut || fnOver); }
});
...
var rhash = /#.*$/, rts = /([?&])_=[^&]*/,
     ...
     * an example) 2) These are called:
     *    - BEFORE asking for a transport
     *    - AFTER param serialization (s.data is a string if s.processData is
     * true) 3) key is the dataType 4) the catchall symbol "*" can be used 5)
     * execution will start with transport dataType and THEN continue down to
     * "*" if needed
     */
    prefilters = {},
...
function ajaxConvert(s, response, jqXHR, isSuccess) {
  var conv2, current, conv, tmp, prev, converters = {},
                                       ...
                                       // Work with a copy of dataTypes in case
                                       // we need to modify it for conversion
...
jQuery.extend({
  ...
  ajax : function(url, options) {
    ...
    var transport,
        ...
        jqXHR = {
          ...
          getAllResponseHeaders :
              function() { return state === 2 ? responseHeadersString : null; },
    ...
    // signature) We also use the url parameter if available
    ...
    s.dataTypes =
        jQuery.trim(s.dataType || "*").toLowerCase().match(rnotwhite) || [ "" ];
    ...
    if (!transport) {
      ...
      if (s.async && s.timeout > 0) {
        timeoutTimer = window.setTimeout(function() { jqXHR.abort("timeout"); },
                                         s.timeout);
      }
  ...
  getJSON : function(
      url, data, callback) { return jQuery.get(url, data, callback, "json"); },

  getScript : function(
      url, callback) { return jQuery.get(url, undefined, callback, "script"); }
});
...
jQuery.fn.extend({
  wrapAll : function(html) {
    ...
    if (jQuery.isFunction(html)) {
      return this.each(function(
          i) { jQuery(this).wrapAll(html.call(this, i)); });
    }
  ...
  wrapInner : function(html) {
    if (jQuery.isFunction(html)) {
      return this.each(function(
          i) { jQuery(this).wrapInner(html.call(this, i)); });
    }
  ...
  wrap : function(html) {
    ...
    return this.each(function(
        i) { jQuery(this).wrapAll(isFunction ? html.call(this, i) : html); });
  },
...
jQuery.expr.filters.hidden = function(
    elem) { return !jQuery.expr.filters.visible(elem); };
jQuery.expr.filters.visible = function(elem) {
  // Support: Opera <= 12.12
  // Opera reports offsetWidths and offsetHeights less than zero on some
  // elements Use OR instead of AND as the element is not visible if either is
  // true See tickets #10406 and #13132
  ...
  if (self.length > 0) {
    jQuery
        ...
        .done(function(responseText) {
          ...
          // "jqXHR" but they are ignored because response was set above. If it
          // fails, this function gets "jqXHR", "status", "error"
        })
...
jQuery.offset = {
  setOffset : function(elem, options, i) {
    var curPosition, curLeft, curCSSTop, curTop, curOffset, curCSSLeft,
        calculatePosition, position = jQuery.css(elem, "position"),
                           curElem = jQuery(elem), props = {};
  ...
  offset : function(options) {
    if (arguments.length) {
      return options === undefined
                 ? this
                 : this.each(function(
                       i) { jQuery.offset.setOffset(this, options, i); });
    }
  ...
  jQuery.cssHooks[prop] =
      addGetHookIf(support.pixelPosition, function(elem, computed) {
        if (computed) {
          ...
          return rnumnonpx.test(computed) ? jQuery(elem).position()[prop] + "px"
                                          : computed;
        }
      });
});
        ...
        jQuery.fn[funcName] = function(margin, value) {
          ...
          return access(this, function(elem, type, value) {
            ...
            if (jQuery.isWindow(elem)) {
              ...
              // Safari, but there isn't a whole lot we can do. See pull request
              // at this URL for discussion:
...
jQuery.fn.extend({
  ...
  delegate : function(selector, types, data,
                      fn) { return this.on(types, selector, data, fn); },
